...
public class LocalBrowserWebDriverContainer<SELF extends LocalBrowserWebDriverContainer<SELF>> extends GenericContainer<SELF> implements VncService, LinkableContainer, TestLifecycleAware {
    ...
    private LocalBrowserWebDriverContainer.VncRecordingMode recordingMode = LocalBrowserWebDriverContainer.VncRecordingMode.RECORD_FAILING;
     ...
     *
     */
    public LocalBrowserWebDriverContainer() {
     ...
     */
    public LocalBrowserWebDriverContainer(String dockerImageName) {
        this();
        ...
        recordingMode = LocalBrowserWebDriverContainer.VncRecordingMode.SKIP;
    }
    ...
    protected Set<Integer> getLivenessCheckPorts() {
        ...
        if (recordingMode == LocalBrowserWebDriverContainer.VncRecordingMode.SKIP) {
    ...
    protected void containerIsStarted(InspectContainerResponse containerInfo) {
        driver = Unreliables.retryUntilSuccess(60, TimeUnit.SECONDS,
    ...
    public SELF withRecordingMode(LocalBrowserWebDriverContainer.VncRecordingMode recordingMode, File vncRecordingDirectory) {
